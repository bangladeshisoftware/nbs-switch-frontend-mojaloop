      ...
      <div className='page-header'>
        <div>
          ...
          <div className='page-subtitle'>
            {accounts.length} accounts registered in Mojaloop Hub
          </div>
        </div>
                  ...
                  <td colSpan={7}>
                    <div className='empty-state'>
                      ...
                      <div className='empty-desc'>
                        Click "+ Create Hub Account" to add one
                      </div>
                    </div>
                  </td>
                </tr>
                ...
                accounts.map((row, i) => (
                  <tr key={row.id ?? i}>
                    ...
                    <td className='td-primary' style={{ fontSize: 12 }}>
                      {row.ledgerAccountType}
                    </td>
                    <td>
                      <span
                        className={`badge ${row.isActive ? 'COMMITTED' : 'FAILED'}`}
                      >
        ...
        <div className='modal-overlay' onClick={() => setModal(false)}>
          ...
          >
            ...
            >
              ...
              >
                Hub accounts are used for multilateral settlement and
                reconciliation between DFSPs.
              </div>
