...
export default function PISPOverview() {
  ...
  if (loading)
    return <div className='loading-screen'>Loading PISP details...</div>;
  if (!pisp)
    return (
      <div style={{ padding: 24, color: 'var(--red)' }}>PISP not found</div>
    );
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            ...
            <div className='page-subtitle'>
              PISP ID: {pisp.pisp_id} · {pisp.currency}
            </div>
          </div>
        </div>
        ...
        <div className='card'>
          <div className='card-header'>
            ...
            <div className='card-subtitle'>
              Hub sends all callbacks to this URL
            </div>
          </div>
          <div className='card-body'>
            <div
