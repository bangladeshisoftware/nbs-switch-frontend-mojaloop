...
export default function Oracles() {
  ...
  const fEndpoint = (k) => (e) =>
    setForm((p) => ({
      ...p,
      endpoint: { ...p.endpoint, [k]: e.target.value },
    }));
      ...
      <div className='page-header'>
        <div>
          ...
          <div className='page-subtitle'>
            {oracles.length} oracles registered in ALS
          </div>
        </div>
                  ...
                  <td colSpan={8}>
                    <div className='empty-state'>
                      ...
                      <div className='empty-desc'>
                        Click "+ Add Oracle" to register an oracle in ALS
                      </div>
                    </div>
                  </td>
                </tr>
                ...
                oracles.map((o, i) => (
                  <tr key={o.oracleId ?? i}>
                    ...
                    <td style={{ fontSize: 12 }}>
                      {o.endpoint?.endpointType || '—'}
                    </td>
                    <td>
                      <span
                        className={`badge ${o.isDefault ? 'COMMITTED' : 'TIMEOUT'}`}
                      >
                        {o.isDefault ? 'YES' : 'NO'}
                      </span>
                    </td>
            ...
            >
              ...
              >
                <div className='input-group'>
                  ...
                  <select
                    ...
                    value={form.oracleIdType}
                    onChange={f('oracleIdType')}
                  >
                    {ID_TYPES.map((t) => (
              ...
              <div className='input-group'>
                ...
                <input
                  ...
                  onChange={fEndpoint('value')}
                  placeholder='http://als-oracle.mojaloop.xyz'
                />
                <div
                  style={{
                    fontSize: 10,
                ...
                >
                  ALS will query this URL to look up participants by{' '}
                  {form.oracleIdType}
                </div>
              </div>
              ...
              >
                <div className='input-group'>
                  ...
                  <select
                    className='select w-full'
                    value={form.endpoint.endpointType}
                    onChange={fEndpoint('endpointType')}
                  >
